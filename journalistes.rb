...
#Annonce du nombre de journalistes dans la database

puts "Il y a #{journalists.length} journalistes."

#Boucle pour les handles avec numéros
...
#Boucle pour les handles commençant par une majuscule
...
#Boucle pour les handles contenant au moins une majuscule
